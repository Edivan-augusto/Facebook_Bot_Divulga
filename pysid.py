    ...
    def run(playwright: Playwright):
        ...
        for i in range(itens.count()):
            ...
            try:
                ...
                # clica no botão "Foto/vídeo" (se precisar abrir o componente)
                page.get_by_role("button", name="Foto/vídeo").click()

                # envia o arquivo direto no input file
                input_file = page.locator('input[type="file"]').first
                input_file.set_input_files("./anuncio.png")
